...
<div class="page-home">
	...
	<section class="home-next-events-section section-padding section-light">
		<div class="home-next-events-section-title section-title row">
			<div class="column text-center">
				<h2 class="relative"><span class="yellow-left-line"></span>Propers espectacles</h2>
				<h3><a href="#" class="black-bold">Veure tota la cartellera ></a></h3>
			</div>
		</div>
		<div class="home-next-events-block">
	...
	<section class="home-about-section section-padding section-light relative">
		...
		<div class="primary-triangle-background-top"></div>
	</section>
	<section class="home-featured-section section-padding section-primary">
		<div class="home-featured-section-title section-title row">
			<div class="column text-center">
