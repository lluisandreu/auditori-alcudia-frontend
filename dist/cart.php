...
<div class="page-cart">
	...
	<section class="cart-section section-padding section-light-gray">
		<div class="cart-section-heading heading-padding text-center">
			<h1 class="section-title"><span class="yellow-left-line"></span>Les meves entrades</h1>
		</div>
			...
			<div class="cart-section-tickets-block">
				<div class="tickets-list">
						...
						<div class="item-footer grid-x grid-padding-x">
							...
							<div class="small-6 cell">
								<ul class="dropdown menu" data-dropdown-menu>
									<li><a href="#" class="blue-link">Descomptes aplicables <i class="fa fa-chevron-right"></a></i>
										<ul class="menu">
											<li><a href="#">Menors de 25 anys</a></li>
											<li><a href="#">Asociació cultural d'Alcúdia</a></li>
											<li><a href="#">Estudiants</a></li>
											<li><a href="#">Escoles</a></li>
											<li><a href="#">Grup familiar</a></li>
											<li><hr></li>
											<li><a href="#" class="blue-link">Eliminar descompte</a></li>
										</ul>
									</li>
								</ul>
							</div>
					...
					<div class="cart-section-ticket item grid-container">
						...
						<div class="item-information grid-x grid-padding-x">
							<div class="item-section section-wheelchair cell small-6 medium-3">
								<span class="item-cell-name">Secció</span>
