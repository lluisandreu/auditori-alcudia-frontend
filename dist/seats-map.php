		...
		<div class="grid-container">
			<div class="grid-x grid-padding-x">
				<div class="seats-map-seats small-12 large-9 cell">
					<div class="seats-map-seats-toggle show-for-small-only">
						<a data-toggle="seats-map-seats-block" class="button small-expanded">Selecciona una o varies butaques del mapa</a>
					</div>
					<div class="seats-map-seats-block expanded" data-toggler=".expanded" id="seats-map-seats-block">
						<div class="seats-block-fullarea">
							<div class="seats-block-amphitheater seats-block-area">
								...
								<div class="seats-row" data-seat-row data-row-wheelchair="true" data-file="2">
									<div class="seats">
										<a href="#" class="seat" data-seat data-num="1" data-wheelchair="true"><i class="seat-icon"></i></a>
										<a href="#" class="seat" data-seat data-num="2"  data-wheelchair="true" data-full="true"><i class="seat-icon"></i></a>
										<a href="#" class="seat" data-seat data-num="3" data-wheelchair="true" data-full="true"><i class="seat-icon"></i></a>
										...
										<a href="#" class="seat" data-seat data-num="8"><i class="seat-icon"></i></a>
										<a href="#" class="seat" data-seat data-num="9"><i class="seat-icon"></i></a>
										<a href="#" class="seat fake-seat" data-seat data-num="6"><i class="seat-icon"></i></a>
									</div>
								</div>
								<div class="seats-row" data-seat-row data-row-wheelchair="true" data-file="3">
									<div class="seats">
				...
				<div class="seats-map-tickets small-12 large-3 cell">
					<div class="seats-map-tickets-toggle show-for-small-only">
						<a data-toggle="seat-map-tickets-block" class="button button-light-gray small-expanded">Confirma les teves entrades</a>
					</div>
